...
ax.XTickLabel = [xx];
ylabel('Eigenvalue');
title('Eigenvalues for different values of n while Romax = 5');
hold on;
plot([0 15],[3 3], 'k-');
plot([0 15],[7 7], 'k-');
plot([0 15],[11 11], 'k-');
...
ax.XTickLabel = [xx];
ylabel('Eigenvalue');
title('Eigenvalues for different values of n while Romax = 3');
hold on;
plot([0 15],[3 3], 'k-');
plot([0 15],[7 7], 'k-');
plot([0 15],[11 11], 'k-');
...
ax.XTickLabel = [xx];
ylabel('Eigenvalue');
title('Eigenvalues for different values of n while Romax = 1');
hold on;
plot([0 15],[3 3], 'k-');
plot([0 15],[7 7], 'k-');
plot([0 15],[11 11], 'k-');
...
ax.XTickLabel = [xx];
ylabel('Eigenvalue');
title('Eigenvalues for different values of n while Romax = 10');
hold on;
plot([0 15],[3 3], 'k-');
plot([0 15],[7 7], 'k-');
plot([0 15],[11 11], 'k-');
