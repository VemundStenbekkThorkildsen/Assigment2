...
\end{center}
\newpage
In the first case we established a sensible value of ${\rho}_{max}$. We were given the analytic solution for the three lowest eigenvalues. By looking at Figure 1,2,3 and 4, it soon becomes clear that using ${\rho}_{max}<5$ does not give the correct eigenvalues.  
