...
$Figure-7$: This figure is showing the number of iterations plotted against n. The growth was calculated to be the second order polynomial $1.9x^2-46.5x+2219.3$
\end{center}
