...
$
\end{center}
We are going to solve this by using a Jacobi rotation algorithm. This uses a lot of similarity transformations. These transformations can be shown to preserve the dot product and orthogonality:
